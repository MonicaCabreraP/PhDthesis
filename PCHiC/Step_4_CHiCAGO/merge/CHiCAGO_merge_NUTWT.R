library(Chicago)
outputDirectory <- ("/gpfs/projects/bsc08/bsc08471/p53/Step2_CHiCAGO/downsampled/NUTWT_recalibration/NUTWT")
...
outprefix <- ("NUTWT")
files <- c(
    file.path("/gpfs/projects/bsc08/bsc08471/p53/Step2_CHiCAGO/downsampled/chinputs/NUT1_WT_downsampled/NUT1_WT_downsampled.chinput"),
    file.path("/gpfs/projects/bsc08/bsc08471/p53/Step2_CHiCAGO/downsampled/chinputs/NUT2_WT_downsampled/NUT2_WT_downsampled.chinput"))
