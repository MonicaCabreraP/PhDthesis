Here you will be able to find the scripts of the figures from the the results section number 1 where I state that p53 activation alters 3D chromatin structure:
